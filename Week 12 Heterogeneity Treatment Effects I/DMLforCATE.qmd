---
title: "Week 11 DML for Conditional Average Treatment Effect"
format:
  pdf:
    pdf-engine: pdflatex 
...
We demonstrate the use of Double Machine Learning to estimate the Conditional Average Treatment Effect. The goal of the example is to estimate the effect of 401(k) eligibility on net financial assets for each value of income.
